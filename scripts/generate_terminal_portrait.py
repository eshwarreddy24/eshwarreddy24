...
<defs>
  <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
    ...
    <stop offset="100%" stop-color="#0b1521"/>
  </linearGradient>
  <linearGradient id="panel" x1="0" y1="0" x2="0" y2="1">
    <stop offset="0%" stop-color="#111c2b"/>
    <stop offset="100%" stop-color="#0c1623"/>
  </linearGradient>
  <linearGradient id="scan" x1="0" y1="0" x2="0" y2="1">
    <stop offset="0%" stop-color="#67b7d1" stop-opacity="0"/>
    <stop offset="50%" stop-color="#67b7d1" stop-opacity=".22"/>
    <stop offset="100%" stop-color="#67b7d1" stop-opacity="0"/>
  </linearGradient>
  ...
  <pattern id="dotPattern" width="5" height="5" patternUnits="userSpaceOnUse">
    <circle cx="2.5" cy="2.5" r="0.8" fill="#91a6ba" opacity=".74"/>
  </pattern>
  ...
  <style>
    ...
    .label{{fill:#8da1b6;font-size:14px}}
    .value{{fill:#f2f6fa;font-size:15px;font-weight:600}}
    .accent{{fill:#67b7d1}}
    .muted{{fill:#71859a}}
    .line{{stroke:#30445a;stroke-width:1}}
    .dotted{{stroke:#2b4055;stroke-width:1;stroke-dasharray:2 4}}
...
<rect x="20" y="18" width="1160" height="614" rx="18" fill="#08111b" stroke="#22384b" stroke-width="2"/>
<rect x="32" y="30" width="1136" height="590" rx="14" fill="#0d1724" stroke="#30485d" stroke-width="1.5"/>

<!-- terminal bar -->
<circle cx="56" cy="54" r="6" fill="#b86f74"/>
<circle cx="78" cy="54" r="6" fill="#c6a96b"/>
<circle cx="100" cy="54" r="6" fill="#70a993"/>
...
<g class="phase-one">
  <rect x="42" y="104" width="430" height="482" rx="8" fill="url(#panel)" stroke="#30485d"/>
  ...
  <path d="M56 174 v-13 h13 M458 174 v-13 h-13 M56 544 v13 h13 M458 544 v13 h-13"
        fill="none" stroke="#67b7d1" stroke-width="1.2"/>
  ...
  <rect x="492" y="104" width="654" height="482" rx="8" fill="url(#panel)" stroke="#30485d"/>
  <text x="508" y="131" class="mono accent" font-size="14" font-weight="700">SYSTEM.INFO</text>
  <circle class="live" cx="904" cy="126" r="4" fill="#70a993"/>
  <text x="918" y="131" class="mono accent" font-size="12" font-weight="700">LIVE</text>
  <rect x="984" y="113" width="146" height="26" rx="13" fill="#142332" stroke="#365168"/>
  ...
  <circle cx="512" cy="558" r="3" fill="#70a993"/>
...
<g class="phase-two">
  <rect x="42" y="104" width="1104" height="482" rx="8" fill="url(#panel)" stroke="#30485d"/>
  ...
  <path d="M74 185 h34 M74 185 v34 M1128 185 h-34 M1128 185 v34 M74 520 h34 M74 520 v-34 M1128 520 h-34 M1128 520 v-34"
        fill="none" stroke="#607a8d" stroke-width="1.2"/>

  <text x="600" y="265" text-anchor="middle" class="mono label" font-size="15" letter-spacing="6">PROCUREMENT  •  SAP  •  DATA  •  AI</text>
  <text x="600" y="350" text-anchor="middle" class="mono welcome" fill="#eaf2f8" font-size="62" font-weight="800">Welcome to <tspan fill="#67b7d1">my world</tspan></text>
  <line x1="365" y1="382" x2="835" y2="382" stroke="#67b7d1" stroke-width="1"/>
...
def main():
    ...
    META.write_text(
        ...
        "Style: restrained navy/slate terminal profile with muted teal accents.\n"
